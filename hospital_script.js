...
function performSearch(){
    ...
    if(checkSearchInput(searchInput)){
        var donors = [{donation_id: 1, donor_name: "Ross Geller",organ: "Kidney",blood_group:"B+"},
                       {donation_id: 2, donor_name: "Chandler Bing",organ: "Kidney",blood_group:"O-"},
                       {donation_id: 3, donor_name: "Rachel Green",organ: "Kidney",blood_group:"A1+"}];
        ...
        for(var i = 0; i < donors.length ; i++){
            ...
            td2.appendChild(document.createTextNode(donors[i].donor_name));
      ...
      footer: 'Tip: Try the keyword \'Kidney\''
    });
    }
...
//Function to alert the user when change password option is selected
function passwordChange(){
Swal.fire({
      type: 'info',
      title: 'In progress',
      text: 'The change password feature will be availabe soon!',
      footer: 'Thanks for your patience.'
    });
}
